...
import { agents, agentApiKeys, approvals, companies, departments, goals, issues, issueComments, projects } from "./schema/index.js";
...
export const db = drizzle(sql, { schema: { agents, agentApiKeys, approvals, companies, departments, goals, issues, issueComments, projects } }) as PostgresJsDatabase<{
