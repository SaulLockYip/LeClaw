    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-black/10">
          <h2 className="text-lg font-semibold text-black">Create Company</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div>
            <label htmlFor="company-name" className="block text-sm font-medium text-black/70 mb-1">
          ...
          <div>
            <label htmlFor="company-description" className="block text-sm font-medium text-black/70 mb-1">
              Description
            </label>
            <textarea
